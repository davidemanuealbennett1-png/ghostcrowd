...
export default function SimulationView({ floorPlan, frame, heatMap, isDone, bottlenecks, agentTypes }) {
  ...
  useEffect(() => {
    ...
    const DEFAULT_COLORS = { customer:[167,139,250], staff:[52,211,153], child:[251,191,36], elderly:[148,163,184] }
    ...
    // Draw walls — solid blue, doors — dashed yellow
    ctx.lineCap = "round"
    ...
    if (frame?.panic) { ctx.fillStyle="rgba(220,38,38,0.06)"; ctx.fillRect(0,0,W,H) }
